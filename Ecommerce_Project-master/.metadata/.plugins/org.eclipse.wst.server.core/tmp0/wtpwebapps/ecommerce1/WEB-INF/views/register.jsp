...
<div class="container-fluid" style="color:red;">
	...
	<div class="row" >
  		...
  		<div class="col-md-6" style="margin-left: 25%; ">
  				<div><p style="color: pink; margin-left: 40%; font-size: 24px; text-shadow: 3px 3px 5px grey; ">Register</p></div>
  			...
  			<form:form action="userSubmit" id="registration" name="registration" modelAttribute="registration" method="post" class="form-group" >
  				...
  				<div class="form-group">
  					<form:label path="emailId">Email:</form:label><span style="color: black">*</span>
  					<form:input type="text" path="emailId" class="form-control" placeholder="Enter Your Email" />
  					 <form:errors path="emailId">  </form:errors>
  				</div>
				<div class="form-group">
  					<form:label path="password">Enter Password:</form:label><span style="color: blue">*</span>
